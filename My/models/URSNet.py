...
class URS7(nn.Module):  # UNet07DRES(nn.Module):

    def __init__(self, in_ch=3, mid_ch=12, out_ch=3):
        super(URS7, self).__init__()
...
class ReHalf_U2NET(nn.Module):
    ...
    def __init__(self, number_of_class=20, in_ch=3, out_ch=1):
        ...
        self.pool45 = nn.AvgPool2d(kernel_size=2, stride=2, ceil_mode=True)

        self.stage5 = RSU4F(256, 128, 256)
        self.pool56 = nn.AvgPool2d(kernel_size=2, stride=2, ceil_mode=True)

        self.stage6 = RSU4F(256, 256, 256)
        # self.Head = SegmentHead(512, 512, number_of_class)

        self.init_weights()
        # --------------------decoder------------xxxxxxxxxxxxxxx
    ...
    def forward(self, x):
        ...
        return hx_fe#, hx12, hx23, hx34  # ,hx1,hx2,hx3,hx4,hx5,hx_fe
