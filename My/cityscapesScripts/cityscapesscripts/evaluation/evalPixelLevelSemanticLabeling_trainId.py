...
from cityscapesScripts.cityscapesscripts.helpers.labels import category2labels, trainId2label
...
# ----------------------------groundTruth file---------------------------------
args.groundTruthSearch = os.path.join("/media/yly/AIvehicle/CITYSCAPES_DATASET/", "gtFine", "val", "*",
...
def getIouScoreForCategory(category, confMatrix, args):
    ...
    notIgnoredAndNotInCategory = [l for l in args.evalLabels if
                                  not trainId2label[l].ignoreInEval and trainId2label[l].category != category]
